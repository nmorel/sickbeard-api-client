...
public class ShowDeleteRequest
    extends NoDataRequest
{
    private static final Logger LOGGER = LoggerFactory.getLogger( ShowDeleteRequest.class );

    private static final String CMD_NAME = "show.delete";
    private static final String PARAM_TVDBID = "tvdbid";

    public ShowDeleteRequest( String tvdbid, SickBeardConfig config )
    {
