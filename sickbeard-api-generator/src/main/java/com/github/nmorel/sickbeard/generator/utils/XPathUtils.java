...
public final class XPathUtils
{
    ...
    /**
     * Get text content of the first child node matching the given node name. Use this method instead of
     * {@link #selectString(String, Object)} whenever xpath support is not required, because it is much faster,
    ...
    protected static class NodeListDecorator
